...
public class ResultadoExchange extends AppCompatActivity {
    ...
    public void obtenerDatosExchange() {
        ...
        call.enqueue(new Callback<ExchangeBuscadorPOJO>() {
            ...
            @Override
            public void onResponse(@NonNull Call<ExchangeBuscadorPOJO> call, @NonNull Response<ExchangeBuscadorPOJO> response) {
                if (response.isSuccessful()) {
                    ...
                    if (datosExchange != null) {
                        ...
                        paisExchange.setText("Pais de residencia:\n" + datosExchange.getCountry());
                            if (webExchange != null) {
                                webExchange.setOnClickListener(view -> {
            ...
            @Override
            public void onFailure(@NonNull Call<ExchangeBuscadorPOJO> call, @NonNull Throwable t) {
